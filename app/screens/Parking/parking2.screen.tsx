...
interface ParkingScreen2Props {
    navigation: any;
}



const ParkingScreen2 = (props: ParkingScreen2Props) =>{
            ...
            <Card>
                ...
                <List.Item
                    ...
                    left={() => 
                        <Avatar.Image
                            size={80}
                            source={{uri: "https://parking-troyitsky.com.ua/image/cache/catalog/jg0b1101-1500x844.jpg"}}
                        />
                    }
                />
                 <List.Item
                    title="Address"
                    description="Stalevariv st,31"
                    left={()=>
