...
interface ParkingScreen5Props {
    navigation: any;
}



const ParkingScreen5 = (props: ParkingScreen5Props) =>{
            ...
            <Card>
                ...
                <List.Item
                    ...
                    left={() => 
                        <Avatar.Image
                            size={80}
                            source={{uri: "https://www.smartparking.org.ua/wp-content/uploads/2022/03/EPWbi0RX0Ac6ikk.jpg"}}
                        />
                    }
                />
                 <List.Item
                    title="Address"
                    description="Patriotychna st,74A"
                    left={()=>
